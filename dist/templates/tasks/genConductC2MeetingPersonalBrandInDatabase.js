...
exports.genConductC2MeetingPersonalBrandInDatabase = void 0;
const constants_1 = require("../../utils/constants");
const clients_1 = require("../../utils/clients");
const shared_1 = require("../utils/shared");
const genConductC2MeetingPersonalBrandInDatabase = async ({ studentName, studentPageId, repPageId, studentId, pbDocLink, repName, leadRepId, }) => {
    ...
    const page = await clients_1.notionClient.pages.create({
        ...
        properties: {
            ...(0, shared_1.addTaskProperties)({
                ...
                taskId: constants_1.CONDUCT_C2_MEETING_PB_TASK,
            }),
        },
    });
...
exports.genConductC2MeetingPersonalBrandInDatabase = genConductC2MeetingPersonalBrandInDatabase;
