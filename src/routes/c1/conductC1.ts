...
const conductC1MeetingInDatabase = async ({
  studentName,
  studentPageId,
  repPageId,
  time,
              ...
              rich_text: [
                {
                  ...
                  text: {
                    content:
                      "Jot down the student’s response. Then, ask the parent ",
                    link: null,
                  },
                  annotations: {
                    bold: true,
              ...
              rich_text: [
                {
                  ...
                  text: {
                    content:
                      "Send the student work call form and parent insight form in the Zoom chat (you can find the links in ",
                    link: null,
                  },
                  annotations: {
                    bold: false,
              ...
              rich_text: [
                {
                  ...
                  text: {
                    content:
                      "Let them know you will also be sending them the forms (alongside any other relevant resources) into the GC (to be completed as a separate task)",
                    link: null,
                  },
                  annotations: {
                    bold: false,
              ...
              rich_text: [
                {
                  ...
                  text: {
                    content:
                      "How do you generally spend your time outside of school? When you describe any activities or extracurriculars you’ve done, try to structure your response in this format that I’ll put in the meeting chat",
                    link: null,
                  },
                  annotations: {
                    bold: false,
              ...
              rich_text: [
                {
                  ...
                  text: {
                    content:
                      "(Try to remind the student if they leave out an option. For example, if they don’t quantify how many people they helped with a personal project or club, ask them to clarify in case they forgot. It’s okay if they genuinely don't know, but most students simply need an additional reminder.)",
                    link: null,
                  },
                  annotations: {
                    bold: false,
              ...
              rich_text: [
                {
                  ...
                  text: {
                    content:
                      "“For the next steps, please fill out the forms I just sent into the chat. The student form is for scheduling the 2nd call, while the parent form is for scheduling the final call.",
                    link: null,
                  },
                  annotations: {
                    bold: false,
            ...
            bulleted_list_item: {
              rich_text: [
                ...
                },
                {
                  ...
                  text: {
                    content:
                      " will have the opportunity to work individually with one of our mentors to directly add value to any component of their applications",
                    link: null,
                  },
                  annotations: {
                    bold: false,
              ...
              rich_text: [
                {
                  ...
                  text: {
                    content:
                      "Describe any quantitive/qualitative impact you had (how many people did you impact, how much money did you fundraise, etc)",
                    link: null,
                  },
                  annotations: {
                    bold: true,
              ...
              rich_text: [
                {
                  ...
                  text: {
                    content:
                      "How was this aligned with your career interests\n",
                    link: null,
                  },
                  annotations: {
                    bold: true,
