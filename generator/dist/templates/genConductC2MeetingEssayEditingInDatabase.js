...
const conductC2MeetingEssayInDatabase = async ({ parentId, }) => {
        ...
        properties: {
            Name: {
                title: [
                    {
                        text: {
                            content: "Conduct C2 Meeting - Essay Editing",
                        },
                    },
                ],
            },
                        ...
                        rich_text: [
                            {
                                type: "text",
                                text: {
                                    content: "Share your screen and explain the revisions you made",
                                    link: null,
                                },
                                annotations: {
                                    bold: false,
                        ...
                        rich_text: [
                            {
                                type: "text",
                                text: {
                                    content: "Have the student complete the revisions and provide feedback on how well they incorporate their suggestions: ",
                                    link: null,
                                },
                                annotations: {
                                    bold: false,
                        ...
                        rich_text: [
                            {
                                type: "text",
                                text: {
                                    content: "“With our progress on your essay so far, I have a couple questions before we wrap up our meeting shortly”",
                                    link: null,
                                },
                                annotations: {
                                    bold: false,
                        ...
                        rich_text: [
                            {
                                type: "text",
                                text: {
                                    content: "“It was great working with you, and developing a compelling essay is not an overnight process—so it’s perfectly normal if we haven’t finalized everything yet”",
                                    link: null,
                                },
                                annotations: {
                                    bold: false,
                        ...
                        rich_text: [
                            {
                                type: "text",
                                text: {
                                    content: "”What did you find most helpful during our meeting” ",
                                    link: null,
                                },
                                annotations: {
                                    bold: false,
                        ...
                        rich_text: [
                            {
                                type: "text",
                                text: {
                                    content: "“What do you feel like you need more help to improve your essay”",
                                    link: null,
                                },
                                annotations: {
                                    bold: false,
                    ...
                    bulleted_list_item: {
                        rich_text: [
                            ...
                            },
                            {
                                type: "text",
                                text: {
                                    content: "https://www.collegiate.dev/c3",
                                    link: {
                                        url: "https://www.collegiate.dev/c3",
                                    },
                                },
                                annotations: {
                                    bold: false,
